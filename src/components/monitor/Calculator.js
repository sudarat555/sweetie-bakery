    ...
    render() {
        ...
        return (
            <div>
                ...
                <hr />
                <button className="btn btn-block btn-danger btn-buy" onClick={()=>this.props.onConfirmOrder()}>ยืนยัน</button>
                <button className="btn btn-block btn-secondary btn-buy mt-2" onClick={()=>this.props.onCancelOrder()}>ยกเลิก</button>
            </div>
        );
    }
}
